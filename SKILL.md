...
description: 生成「AI信号站」每日 AI 投研简版 HTML 日报（4 模块：📢 一线观点 / 🧠 技术前沿 / 🚀 产品动态 / 💰 资本市场）。当用户说"完成【日期】AI信号站复盘"、要求生成 AI 信号站日报、或按 4 模块框架整理当日 AI 资讯时使用。要求数据真实、每条附来源链接、不伪造。
agent_created: true
---
...
- 内容字符串**统一用三单引号 `'''...'''`** 包裹，避免中文弯引号与 ASCII 直引号冲突。
